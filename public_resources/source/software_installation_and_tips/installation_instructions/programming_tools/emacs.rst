...
* For Ubuntu/Debian/Mint:
  ...
  * For the latest development version (Ubuntu only):
    ...
    * Check out the :ref:`introduction_to_emacs` guide for pointers on using Emacs
...
3. To run Emacs, navigate to ``emacs/bin`` under the newly extracted folder and double-click on
   runemacs.exe.
4. Check out the :ref:`introduction_to_emacs` guide for pointers on using Emacs
